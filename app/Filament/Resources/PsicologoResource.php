...
class PsicologoResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Psicólogos';

    protected static ?string $modelLabel = 'Psicólogo';

    protected static ?string $pluralModelLabel = 'Psicólogos';

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->role('psicologo');
    }
